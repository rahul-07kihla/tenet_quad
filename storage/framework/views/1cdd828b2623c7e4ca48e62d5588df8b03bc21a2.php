...
<body class="hold-transition skin-blue sidebar-mini <?php echo e(isset($is_collapse) && $is_collapse == 'No' ? '' : 'sidebar-collapse'); ?>">
    ...
    <input type="hidden" id="default_currency" value="<?php echo e(!empty($setting) ? $setting->currency : ""); ?>" />
    <input type="hidden" name="hidden_currency" class="hidden_currency" id="hidden_currency"
    value="<?php echo e(!empty($setting) ? $setting->currency : ""); ?>">
...
<?php /**PATH C:\Users\Rahul\Downloads\tenet_project\iproduction_null\resources\views/layouts/app.blade.php ENDPATH**/ ?>