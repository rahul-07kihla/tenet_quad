                    ...
                    <ul class="menu-list">
                        ...
                        <li class="user-info-box">
                            <div class="user-profile">
                                ...
                                <?php if(!empty(Auth::user()->photo) && Auth::user()->photo != null && file_exists('uploads/user_photos/' . Auth::user()->photo)): ?>
                                    ...
                                    <li class="common-margin">
                                        <div>
                                            <div class="user-info d-flex align-items-center">
                                                <?php if(!empty(Auth::user()->photo) && Auth::user()->photo != null and file_exists('uploads/user_photos/' . Auth::user()->photo)): ?>
                                                ...
                                                <?php endif; ?>
                                                <div class="ps-2">
                                                    <p class="user-name mb-0 font-weight-700"><?php echo e(!empty(Auth::user()->name) ? Auth::user()->name : ""); ?>

                                                    </p>
                                                    <span
                                                        class="user-role user-role-second"><?php echo e(!empty(Auth::user()->designation) ? Auth::user()->designation : ""); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
...
<?php /**PATH C:\Users\Rahul\Downloads\tenet_project\iproduction_null\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>